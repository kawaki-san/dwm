...
static const unsigned int systrayonleft = 0;	/* 0: systray in the right corner, >0: systray on leleft of status text */
...
static const char *fonts[]          = { "monospace:size=11.5", "Font Awesome 6 Free Regular:size:12" };
static const char dmenufont[]       = "monospace:size=11.5";
static char normbgcolor[]           = "#282828";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#eeeeee";
static char selbordercolor[]        = "#7daea3";
static char selbgcolor[]            = "#7daea3";
static char col_bg[]          = "#1d2021";
static char col_dark[]        = "#282828";
static char col_fg[]          = "#d4be98";
static char col_black[]       = "#32302f";
static char col_red[]         = "#ea6962";
static char col_yellow[]      = "#d8a657";
static char col_white[]       = "#d4be98";
static char col_br_black[]    = "#32302f";
static char col_br_red[]      = "#ea6962";
static char col_br_green[]    = "#a9b665";
static char col_br_yellow[]   = "#d8a657";
static char col_br_blue[]     = "#7daea3";
static char col_br_magenta[]  = "#d3869b";
static char col_br_cyan[]     = "#89b482";
...
static const char *dmenucmd[] = { "dmenu_run", "-b", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", normbgcolor, NULL };
